...
class Ui_QuickAdmin(object):
    def setupUi(self, dbadmin):
        dbadmin.setObjectName("QuickAdmin")
        dbadmin.resize(640, 641)
        self.tableTracks = QtWidgets.QTableWidget(dbadmin)
